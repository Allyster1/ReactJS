   ...
   return (
      <section className="section colored" id="pricing-plans">
         <div className="container">
            ...
            <div className="row">
               {/* ***** Pricing Item Start ***** */}
               <PricingItem title="Starter" price={14.5} space={60} transfer={600} hasPro />
               <PricingItem title="Premium" price={21.5} space={120} transfer={1200} hasPro hasSupport isActive />
               <PricingItem
                  title="Advanced"
                  price={42.0}
                  space={250}
